...
void performNwayAssociativeMappingforPart1()
{
    ...
    ca = i;
    int selection = 0;
    printf("Select 1 for fully associative execution, 2 for 2 way execution, 4 for 4 way execution, 8 for 8 way execution: %d",j);
    // scanf("%d", &selection);
    selection = j;
    switch (ca)
    {
...
void performNwayAssociativeMappingforPart2()
{
 ...
 long cacheSize = 16 * 1024;
    int totalNumberOfBlocks = 0;
    int ca = 0;
    printf("For execution over 64Bytes Cache line size ,Click 1 for 16KB Cachesize, 2 for 32KB Cachesize, 3 for 64KB Cachesize %d \n  \n",i);
   // scanf("%d", &ca);
   ca=i;
    int selection;
    printf("Select 1 for fully associative execution, 2 for 2 way execution, 4 for 4 way execution, 8 for 8 way execution: %d",j);
